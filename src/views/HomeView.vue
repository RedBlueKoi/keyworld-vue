...
<template>
  <main class="px-4 py-6">
    ...
    <div
      class="py-6 grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 h-full">
      <router-link
        ...
        <div
          class="absolute top-0 left-0 pb-6 w-full h-full flex justify-center items-end bg-primary bg-opacity-40 text-white hover:opacity-0 transition-opacity duration-200 ease-in-out">
          {{ category.name }}
        </div>
      </router-link>
    </div>
